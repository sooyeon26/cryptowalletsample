...
public class SendEtherFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ImageButton scanQRCode = view.findViewById(R.id.scanQRCodeButton);
        ...
        setScanQRCodeClickListener(scanQRCode);
    ...
    private void setSignTransactionButtonOnClickListener(Button signTransactionButton) {
        signTransactionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String toAddress = mReceiverAccountField.getText().toString();
    ...
    private void setScanQRCodeClickListener(ImageButton scanQRCode) {
