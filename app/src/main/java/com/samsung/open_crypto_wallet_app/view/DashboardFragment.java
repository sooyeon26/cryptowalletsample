...
public class DashboardFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button copyPublicAddressButton = view.findViewById(R.id.copyPublicAddressButton);
        setCopyPublicAddressButtonOnClickListener(copyPublicAddressButton);
        Button sharePublicAddressButton = view.findViewById(R.id.sharePublicAddressButton);
        setSharePublicAddressButtonOnClickListener(sharePublicAddressButton);
